...
#        pt.bg = c("brown", "darkgreen", "red", "blue"), pt.cex = 2.5,
#        pt.lwd = 2, bty = 'n')

# Legend
legend(0.05, 0.1, c("soil", "sediment", "gut", "water"),
       pch = c(24, 22, 21, 23), xpd = NA,
       pt.bg = c("brown", "darkgreen", "red", "blue"), pt.cex = 2.2, cex = 2,
       pt.lwd = 0, bty = 'n', ncol = 2)
